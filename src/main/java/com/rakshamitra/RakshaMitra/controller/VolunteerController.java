...
public class VolunteerController {
    ...
    public String registerVolunteer(@ModelAttribute Volunteer volunteer, Model model) {
        try {
            ...
            return "redirect:/volunteer/login"; // Redirect to login page after successful registration
    ...
    @GetMapping("/admin/volunteers/pending")
    ...
    @PostMapping("/admin/volunteer/approve/{id}")
    public String approveVolunteer(@PathVariable Long id) {
        volunteerService.approveVolunteer(id);
        return "redirect:/admin/volunteers/pending"; // Redirect back to pending volunteers
    }
}
